...
translations = {
    'ar': {
        ...
        'Ajouter un mot personnel': 'إضافة كلمة شخصية', 'Un détail important, une précision sur le quartier ou vos conditions de visite…': 'تفصيل مهم أو توضيح عن الحي أو شروط الزيارة…', 'La description principale est déjà créée à partir de vos réponses. Cet espace vous permet d’ajouter un complément si vous le souhaitez.': 'تم إنشاء الوصف الرئيسي من إجاباتك. يمكنك إضافة تفاصيل هنا إذا رغبت.', 'Titre de l’annonce': 'عنوان الإعلان', 'Votre nom': 'اسمك', 'Votre numéro de téléphone': 'رقم هاتفك', 'Votre e-mail': 'بريدك الإلكتروني', 'Qui publie l’annonce ?': 'من ينشر الإعلان؟', 'Je publie mon propre bien.': 'أنشر عقاري الخاص.', 'Je publie pour un client.': 'أنشر لصالح عميل.', 'Les informations du bien': 'معلومات العقار', 'Type de bien': 'نوع العقار', 'Ville': 'المدينة', 'Quartier': 'الحي', 'Prix demandé': 'السعر المطلوب', 'Nombre de chambres': 'عدد غرف النوم', 'Nombre de salons': 'عدد غرف الجلوس', 'Nombre de salles de bains': 'عدد الحمامات', 'Superficie (m²)': 'المساحة (م²)', 'Superficie de la terrasse (m²)': 'مساحة التراس (م²)', 'Photos du bien': 'صور العقار', 'Continuer': 'متابعة', 'Retour': 'رجوع', 'Valider avec WhatsApp': 'التأكيد عبر واتساب', 'Vendre': 'بيع', 'Louer': 'كراء', 'Propriétaire': 'مالك', 'Terrasse': 'تراس', 'Ascenseur': 'مصعد', 'Garage ou sous-sol': 'مرآب أو قبو', 'Votre aperçu': 'معاينتك', 'Publier': 'نشر', 'Appartement': 'شقة', 'Appartements': 'شقق', 'Maison': 'منزل', 'Maisons': 'منازل', 'Villa': 'فيلا', 'Villas': 'فيلات', 'Terrain': 'أرض', 'Local commercial': 'محل تجاري', 'Bureau': 'مكتب', 'Bâtiment professionnel': 'مبنى مهني', 'Résidence': 'إقامة', 'À vendre': 'للبيع', 'À louer': 'للكراء', 'Location': 'كراء', 'À partir de': 'ابتداءً من', 'Baisse de prix': 'انخفاض السعر', 'Voir l\'annonce': 'أنظر الإعلان', 'Ajouter aux favoris': 'إضافة إلى المفضلة', 'Aperçu rapide': 'معاينة سريعة', 'Contact direct': 'اتصال مباشر', 'Prix sur demande': 'السعر عند الطلب', 'Trier par': 'فرز حسب', 'Pertinence': 'الأفضلية', 'Date de publication': 'تاريخ النشر', 'Prix le plus bas': 'الأقل سعراً', 'Prix le plus élevé': 'الأعلى سعراً', 'Nombre de pièces': 'عدد الغرف', 'Studio': 'استوديو', 'Pièce principale': 'الغرفة الرئيسية', 'Chambre': 'غرفة نوم', 'Chambres': 'غرف النوم', 'Salon': 'غرفة جلوس', 'Salons': 'غرف الجلوس', 'Salle de bains': 'حمّام', 'Salles de bains': 'الحمّامات', 'Jardin': 'حديقة', 'Balcon': 'شرفة', 'Terrasse': 'تراس', 'Piscine': 'مسبح', 'Garage': 'مرآب', 'Parking': 'موقف سيارات', 'Ascenseur': 'مصعد', 'Meublé': 'مفروش', 'Non meublé': 'غير مفروش', 'Cuisine équipée': 'مطبخ مجهز', 'Réfrigérateur': 'ثلاجة', 'Four': 'فرن', 'Machine à laver': 'آلة غسيل', 'Micro-ondes': 'ميكروويف', 'Télévision': 'تلفزيون', 'Internet': 'إنترنت', 'Climatisation': 'تكييف', 'Climatisation centrale': 'تكييف مركزي', 'Cheminée': 'مدفأة', 'Sécurité': 'حراسة', 'Porte blindée': 'باب مصفحة', 'Double vitrage': 'زجاج مزدوج', 'Animaux domestiques autorisés': 'مسموح بدخول الحيوانات الأليفة', 'Quartier': 'الحي', 'Centre-ville': 'وسط المدينة', 'Surface': 'المساحة', 'Superficie': 'المساحة', 'Étage': 'الطابق', 'Vue sur les montagnes': 'مطلة على الجبال', 'Pour plus d’informations': 'لمزيد من المعلومات', 'N’hésitez pas à nous contacter': 'لا تتردد في الاتصال بنا', 'Maroc': 'المغرب', 'Votre aperçu': 'معاينتك',
    },
    'en_US': {
