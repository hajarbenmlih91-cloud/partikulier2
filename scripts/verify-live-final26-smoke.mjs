...
const out = process.env.PK_REPORT || `documentation/live-final26-smoke-${browserName}.json`;
const results = [];
...
const report = { test_id: 'LIVE-FINAL26-SMOKE', browser: browserName, base, status: failed.length ? 'FAIL' : 'PASS', passed: results.length - failed.length, failed: failed.length, results, limitations: ['Le smoke test ne remplace pas les signoffs humains, la capacité 10 RPS, ni la mesure contractuelle TTFB/LCP.'] };
