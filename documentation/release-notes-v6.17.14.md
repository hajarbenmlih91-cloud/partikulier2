# Partikulier v6.17.14 — reproductibilité et acceptance froide
...
Le tag v6.17.12 a été bloqué par GitHub Actions avant package et release : son job statique exécutait le contrôle du checksum depuis la racine alors que le manifeste contenait le nom relatif `estatik-4.3.4.zip`. v6.17.14 corrige les deux occurrences avec `cd vendor-artifacts && sha256sum -c --strict estatik-4.3.4.zip.sha256`. Le tag v6.17.12 reste immuable et aucune release v6.17.12 n’a été créée.
