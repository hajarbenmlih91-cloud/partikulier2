# Validation de la candidate v6.17.14

La candidate v6.17.14 est dérivée de `v6.17.13@7177dcf611ab22f22d289e8d3faf3e0c9c14abcb` et comparée à la base CDC `v6.17.7@6153debac8f84da46b1da95af1c810320dc7e5bf`. Les tags v6.17.7, v6.17.11, v6.17.12 et v6.17.13 ne sont pas réécrits.
...
Le workflow `.github/workflows/cdc-v6.17.14.yml` impose l’ordre `static-contracts → cold-acceptance → package → release`. Le job `cold-acceptance` reconstruit l’environnement et publie ses preuves. Le job `package` dépend de l’acceptance et vérifie le bundle. Le job `release` dépend du package, est limité au tag `v6.17.14`, vérifie le checksum du ZIP et ne crée la release qu’après succès des étapes précédentes.
