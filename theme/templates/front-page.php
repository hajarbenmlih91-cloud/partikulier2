...
<?php if ( $featured ) : $property = $featured[0]; $img = Partikulier_AVIF::first_image( $property->ID ); ?><a class="pk-editorial-feature" href="<?php echo esc_url( get_permalink( $property ) ); ?>"><?php if ( $img ) : ?><img src="<?php echo esc_url( $img ); ?>" width="1600" height="900" alt="<?php echo esc_attr( get_the_title( $property ) ); ?>" loading="lazy" decoding="async"><?php endif; ?><span class="pk-editorial-feature__veil"></span><span class="pk-editorial-feature__content"><strong><?php echo esc_html( get_the_title( $property ) ); ?></strong><small><?php echo esc_html( Partikulier_Geo::location_string( $property->ID ) ); ?></small></span></a><?php else : ?><div class="pk-editorial-empty"><strong><?php echo esc_html( Partikulier_Localization::translate_polylang_string( 'Les premières annonces apparaîtront ici.', 'Les premières annonces apparaîtront ici.', 'partikulier' ) ); ?></strong><span><?php echo esc_html( Partikulier_Localization::translate_polylang_string( 'Déposez un bien gratuitement pour ouvrir cette sélection.', 'Déposez un bien gratuitement pour ouvrir cette sélection.', 'partikulier' ) ); ?></span><a class="pk-btn pk-btn-dark" href="<?php echo esc_url( $deposit ); ?>"><?php echo esc_html( Partikulier_Localization::translate_polylang_string( 'Déposer une annonce', 'Déposer une annonce', 'partikulier' ) ); ?></a></div><?php endif; ?></div></section>
	...
	<section class="pk-editorial-section"><div class="pk-container"><div class="pk-editorial-heading"><p class="pk-editorial-kicker"><?php echo esc_html( Partikulier_Localization::translate_polylang_string( 'Trouvez votre bien', 'Trouvez votre bien', 'partikulier' ) ); ?></p><h2><?php echo esc_html( Partikulier_Localization::translate_polylang_string( 'Une recherche qui commence par le bon lieu.', 'Une recherche qui commence par le bon lieu.', 'partikulier' ) ); ?></h2><p><?php echo esc_html( Partikulier_Localization::translate_polylang_string( 'Parcourez les catégories sans bruit, puis laissez les détails vous guider.', 'Parcourez les catégories sans bruit, puis laissez les détails vous guider.', 'partikulier' ) ); ?></p></div><div class="pk-editorial-types"><?php if ( ! is_wp_error( $pk_home_types ) && $pk_home_types ) : foreach ( $pk_home_types as $term ) : ?><a href="<?php echo esc_url( pk_term_url( $term, $archive ) ); ?>" class="pk-editorial-type"><span class="pk-editorial-type__icon"><?php echo pk_type_icon( $term->slug ); // phpcs:ignore ?></span><strong><?php echo esc_html( $term->name ); ?></strong><small><?php echo esc_html( number_format_i18n( $term->count ) ); ?> <?php echo esc_html( Partikulier_Localization::translate_polylang_string( 'annonces', 'annonces', 'partikulier' ) ); ?></small></a><?php endforeach; else : foreach ( array( 'Appartement', 'Maison', 'Terrain', 'Parking', 'Immeuble', 'Local' ) as $label ) : ?><a href="<?php echo esc_url( $archive ); ?>" class="pk-editorial-type"><span class="pk-editorial-type__icon"><?php echo pk_type_icon( sanitize_title( $label ) ); // phpcs:ignore ?></span><strong><?php echo esc_html( class_exists( 'Partikulier_Localization' ) ? Partikulier_Localization::translate_polylang_string( $label, $label, 'partikulier' ) : esc_html__( $label, 'partikulier' ) ); ?></strong><small><?php echo esc_html( class_exists( 'Partikulier_Localization' ) ? Partikulier_Localization::translate_polylang_string( 'Explorer', 'Explorer', 'partikulier' ) : __( 'Explorer', 'partikulier' ) ); ?></small></a><?php endforeach; endif; ?></div></div></section>
	...
	<section class="pk-editorial-section"><div class="pk-container pk-editorial-places"><div><p class="pk-editorial-kicker"><?php echo esc_html( Partikulier_Localization::translate_polylang_string( 'Proche de chez vous', 'Proche de chez vous', 'partikulier' ) ); ?></p><h2><?php echo esc_html( Partikulier_Localization::translate_polylang_string( 'Trouvez un bien dans votre ville.', 'Trouvez un bien dans votre ville.', 'partikulier' ) ); ?></h2><p><?php echo esc_html( Partikulier_Localization::translate_polylang_string( 'Les quartiers et villes sont indexés pour vous aider à trouver plus vite.', 'Les quartiers et villes sont indexés pour vous aider à trouver plus vite.', 'partikulier' ) ); ?></p><a class="pk-btn pk-btn-dark" href="<?php echo esc_url( $archive ); ?>"><?php echo esc_html( Partikulier_Localization::translate_polylang_string( 'Explorer les annonces', 'Explorer les annonces', 'partikulier' ) ); ?></a></div><div class="pk-editorial-place-list"><?php if ( $pk_home_cities ) : foreach ( $pk_home_cities as $city ) : ?><a href="<?php echo esc_url( pk_term_url( $city, $archive ) ); ?>"><span><?php echo esc_html( $city->name ); ?></span><small><?php echo esc_html( number_format_i18n( $city->count ) ); ?></small><span aria-hidden="true">→</span></a><?php endforeach; else : ?><p class="pk-editorial-empty-text"><?php echo esc_html( Partikulier_Localization::translate_polylang_string( 'Les villes apparaîtront dès les premières annonces.', 'Les villes apparaîtront dès les premières annonces.', 'partikulier' ) ); ?></p><?php endif; ?></div></div></section>

	<section class="pk-editorial-region-band"><div class="pk-container pk-editorial-region-band__inner"><div><p class="pk-editorial-kicker"><?php echo esc_html( Partikulier_Localization::translate_polylang_string( 'Par région', 'Par région', 'partikulier' ) ); ?></p><h2><?php echo esc_html( Partikulier_Localization::translate_polylang_string( 'Partout au Maroc.', 'Partout au Maroc.', 'partikulier' ) ); ?></h2></div><div class="pk-editorial-region-list"><?php if ( $regions ) : foreach ( $regions as $region ) : ?><a href="<?php echo esc_url( pk_term_url( $region, $archive ) ); ?>"><?php echo esc_html( $region->name ); ?> <span aria-hidden="true">→</span></a><?php endforeach; else : ?><a href="<?php echo esc_url( $archive ); ?>"><?php echo esc_html( Partikulier_Localization::translate_polylang_string( 'Toutes les annonces', 'Toutes les annonces', 'partikulier' ) ); ?> <span aria-hidden="true">→</span></a><?php endif; ?></div></div></section>
